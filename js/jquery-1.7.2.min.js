...
(function (a, b) {
    ...
    f.extend({
        ...
        var b, d, e, g, h, i, j, k, l, m, n, o, cf, p = c.createElement("div"), q = c.documentElement;
        ...
        !p.addEventListener && p.attachEvent && p.fireEvent && (p.attachEvent("onclick", cf = function () {
            b.noCloneEvent = !1
